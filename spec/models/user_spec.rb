...
RSpec.describe User, type: :model do
  ...
  describe "relationship between admins and employees" do
    it "allows for admins to be associated with multiple employees" do
      employees_1 = FactoryGirl.create(:user)
      employees_2 = FactoryGirl.create(:user)
      admin = FactoryGirl.create(:admin_user)
      Hand.create!(user_id: admin.id, hand_id: employees_1.id)
      Hand.create!(user_id: admin.id, hand_id: employees_2.id)
